...
var estimatePrivateCarDrivingIntensity = function estimatePrivateCarDrivingIntensity(carIntensityFactorFirstKey, carPassengersFirstKey, carChargingKey, electricityIntensityKey) {
  ...
  // PHV, EVの補正
  if (carIntensityFactorFirstKey === 'phv' || carIntensityFactorFirstKey === 'ev') {
    // PHV, EVの場合は自宅での充電割合と再生エネルギー電力の割合で補正
    var electricityIntensityFactor = getParameter('electricity-intensity-factor', electricityIntensityKey).value * getParameter('car-charging', carChargingKey).value;
    // GHG原単位の補正係数を電力割合で補正
    ghgIntensityRatio = ghgIntensityRatio * (1 - electricityIntensityFactor) + getParameter('renewable-car-intensity-factor', carIntensityFactorFirstKey + '_driving-factor').value * electricityIntensityFactor;
  }
  // 人数補正値
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass(ExtensionBlocks, [{
    ...
    value: function privateCarDriving(args) {
      var carIntensityFactorFirstKey = cast.toString(args.carIntensityFactorFirstKey);
